...
public class AboutDates {
	...
	public void dateToString() {
		assertEquals(date.toString(), "Sat Mar 03 05:33:21 MST 1973");
	}
	...
	public void changingDateValue() {
		...
		assertEquals(date.toString(), "Sat Mar 03 06:33:21 MST 1973");
	}
	...
	public void usingCalendarToChangeDates() {
		...
		assertEquals(cal.getTime().toString(), "Tue Apr 03 06:33:21 MST 1973");
	}
	...
	public void usingRollToChangeDatesDoesntWrapOtherFields() {
		...
		assertEquals(cal.getTime().toString(), "Sat Mar 03 06:33:21 MST 1973");
	}
	...
	public void usingDateFormatToParseDates() throws ParseException {
		...
		assertEquals(date2.toString(), "Sat Jan 01 00:00:00 MST 2000");
